...
/* taken from the PHP iCalendar project */
/* minor modifications by me -ARN */
...
$language 				= 'Dutch';		// Language support - 'English', 'Polish', 'German', 'French', 'Dutch', 'Danish', 'Italian', 'Japanese', 'Norwegian', 'Spanish', 'Swedish', 'Portuguese', 'Catalan', 'Traditional_Chinese', 'Esperanto', 'Korean'
...
$calendar_path 			= '/home/qharmony/public_html/kalender/phpicalendar-1.1/calendars';				// Leave this blank on most installs, place your full path to calendars if they are outside the phpicalendar folder.
...
$save_parsed_cals 		= 'no';			// Recommended 'yes'. Saves a copy of the cal in /tmp after it's been parsed. Improves performence - but doesn't work for web calendars.
...
$list_webcals[] = 'http://archief.qharmony.nl/kalender/WebCalendar-0.9.43-new/publish.php/bestuur.ics';
$list_webcals[] = 'http://archief.qharmony.nl/kalender/WebCalendar-0.9.43-new/publish.php/__public__.ics';						// to show up in your calendar list. You must prefix the URL with http://
